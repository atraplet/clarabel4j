...
/**
 * {@snippet lang=c :
 * struct ClarabelDefaultSolution_f32 {
 *     float *x;
 *     uintptr_t x_length;
 *     float *z;
 *     uintptr_t z_length;
 ...
 * }
 */
public class ClarabelDefaultSolution_f32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Clarabel_h.C_FLOAT.withName("obj_val"),
        Clarabel_h.C_FLOAT.withName("obj_val_dual"),
        MemoryLayout.paddingLayout(4),
        Clarabel_h.C_DOUBLE.withName("solve_time"),
        Clarabel_h.C_INT.withName("iterations"),
        Clarabel_h.C_FLOAT.withName("r_prim"),
        Clarabel_h.C_FLOAT.withName("r_dual"),
        MemoryLayout.paddingLayout(4)
    ).withName("ClarabelDefaultSolution_f32");
    ...
    private static final OfFloat obj_val$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("obj_val"));
     ...
     * }
     */
    public static final OfFloat obj_val$layout() {
        return obj_val$LAYOUT;
    }

    private static final long obj_val$OFFSET = 52;
     ...
     * }
     */
    public static float obj_val(MemorySegment struct) {
     ...
     * }
     */
    public static void obj_val(MemorySegment struct, float fieldValue) {
        struct.set(obj_val$LAYOUT, obj_val$OFFSET, fieldValue);
    }

    private static final OfFloat obj_val_dual$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("obj_val_dual"));
     ...
     * }
     */
    public static final OfFloat obj_val_dual$layout() {
        return obj_val_dual$LAYOUT;
    }

    private static final long obj_val_dual$OFFSET = 56;
     ...
     * }
     */
    public static float obj_val_dual(MemorySegment struct) {
     ...
     * }
     */
    public static void obj_val_dual(MemorySegment struct, float fieldValue) {
    ...
    private static final long solve_time$OFFSET = 64;
    ...
    private static final long iterations$OFFSET = 72;
    ...
    private static final OfFloat r_prim$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("r_prim"));
     ...
     * }
     */
    public static final OfFloat r_prim$layout() {
        return r_prim$LAYOUT;
    }

    private static final long r_prim$OFFSET = 76;
     ...
     * }
     */
    public static float r_prim(MemorySegment struct) {
     ...
     * }
     */
    public static void r_prim(MemorySegment struct, float fieldValue) {
        struct.set(r_prim$LAYOUT, r_prim$OFFSET, fieldValue);
    }

    private static final OfFloat r_dual$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("r_dual"));
     ...
     * }
     */
    public static final OfFloat r_dual$layout() {
        return r_dual$LAYOUT;
    }

    private static final long r_dual$OFFSET = 80;
     ...
     * }
     */
    public static float r_dual(MemorySegment struct) {
     ...
     * }
     */
    public static void r_dual(MemorySegment struct, float fieldValue) {
