...
/**
 * {@snippet lang=c :
 * struct ClarabelSupportedConeT_f32 {
 ...
 * }
 */
public class ClarabelSupportedConeT_f32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            MemoryLayout.structLayout(
                Clarabel_h.C_FLOAT.withName("power_cone_t")
            ).withName("$anon$118:9"),
            MemoryLayout.structLayout(
    ...
    ).withName("ClarabelSupportedConeT_f32");
    ...
    private static final OfLong zero_cone_t$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$103:5"), groupElement("$anon$105:9"), groupElement("zero_cone_t"));
    ...
    private static final OfLong nonnegative_cone_t$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$103:5"), groupElement("$anon$109:9"), groupElement("nonnegative_cone_t"));
    ...
    private static final OfLong second_order_cone_t$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$103:5"), groupElement("$anon$113:9"), groupElement("second_order_cone_t"));
    ...
    private static final OfFloat power_cone_t$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$103:5"), groupElement("$anon$118:9"), groupElement("power_cone_t"));
     ...
     * }
     */
    public static final OfFloat power_cone_t$layout() {
     ...
     * }
     */
    public static float power_cone_t(MemorySegment struct) {
     ...
     * }
     */
    public static void power_cone_t(MemorySegment struct, float fieldValue) {
        struct.set(power_cone_t$LAYOUT, power_cone_t$OFFSET, fieldValue);
    }

    private static final AddressLayout genpow_cone_alpha_t$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$103:5"), groupElement("$anon$122:9"), groupElement("genpow_cone_alpha_t"));
    ...
    private static final OfLong genpow_cone_dim1_t$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$103:5"), groupElement("$anon$122:9"), groupElement("genpow_cone_dim1_t"));
    ...
    private static final OfLong genpow_cone_dim2_t$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$103:5"), groupElement("$anon$122:9"), groupElement("genpow_cone_dim2_t"));
